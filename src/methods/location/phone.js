...
import { areacode as areacodeFn } from "../location";
  ...
  switch (options.country) {
    case "fr":
      if (!options.mobile) {
        ...
        numPick =
          pick(["06", "07"]) + string({ pool: "0123456789", length: 8 });
        phone = options.formatted ? numPick.match(/../g).join(" ") : numPick;
      }
      break;
    case "uk":
      if (!options.mobile) {
        numPick = pick([
          ...
          {
            area: "01" + character({ pool: "234569" }) + "1 ",
            sections: [3, 4]
          },
          ...
          {
            area:
              "028 " + pick(["25", "28", "37", "71", "82", "90", "92", "95"]),
            sections: [2, 4]
          },
          {
            area: "012" + pick(["04", "08", "54", "76", "97", "98"]) + " ",
            sections: [6]
          },
          { area: "013" + pick(["63", "64", "84", "86"]) + " ", sections: [6] },
          {
            area: "014" + pick(["04", "20", "60", "61", "80", "88"]) + " ",
            sections: [6]
          },
          { area: "015" + pick(["24", "27", "62", "66"]) + " ", sections: [6] },
          {
            area: "016" + pick(["06", "29", "35", "47", "59", "95"]) + " ",
            sections: [6]
          },
    ...
    case "za":
      ...
      break;
    case "us":
      var areacode = areacodeFn(options).toString();
      var exchange =
        natural({ min: 2, max: 9 }).toString() +
