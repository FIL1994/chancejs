...
test("streetSuffix() returns a single suffix", t => {
  _.times(1000, () => {
    let suffix = chance.streetSuffix();
...
// chance.streetSuffixes()
test("streetSuffixes() returns the suffix array", t => {
  let suffixes = chance.streetSuffixes();
...
test("streetSuffixes() are short", t => {
  let suffixes = chance.streetSuffixes();
  suffixes.map(suffix => {
...
test("streetSuffixes() are longish", t => {
  let suffixes = chance.streetSuffixes();
  suffixes.map(suffix => {
